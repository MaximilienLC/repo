  ...
  - [\>\>\> SPECIFICATIONS](#-specifications)
    - [I. Overview](#i-overview)
      - [1. Description](#1-description)
        - [a. Evolution stages](#a-evolution-stages)
        - [b. Types of evolutionary algorithms](#b-types-of-evolutionary-algorithms)
      - [2. Details](#2-details)
    - [II. Agent roles](#ii-agent-roles)
      - [1. Description](#1-description-1)
        - [a. Optimization types](#a-optimization-types)
      - [b. Mutator role and variation stage](#b-mutator-role-and-variation-stage)
...
This directory hosts **neuroevolution** methods (**evolutionary algorithms** optimizing **artificial neural networks**)  that we are developping. This directory does not contain any experimentation code.
...
##### b. Types of evolutionary algorithms
...
#### b. Mutator role and variation stage
